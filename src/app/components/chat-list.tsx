              ...
              >
                {m.role === 'user' ? (
                  <div className='flex justify-end'>
                    <div className='rounded-md rounded-br-none bg-gray-100 shadow px-2 py-1 w-fit'>
                      {m.content}
                    </div>
                    <svg
                  ...
                  <div className='flex justify-start'>
                    ...
                    <div className='rounded-md rounded-bl-none bg-green-200 shadow shadow-green-300 px-2 py-1 w-fit'>
                      {m.content}
                    </div>
                  </div>
                )}
